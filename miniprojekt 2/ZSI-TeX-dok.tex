...
\subsection{Role w projekcie}
	...
	\begin{itemize}
		\item \textbf{Beniamin Stecuła (Osoba 1)} -- Inżynier Infrastruktury. Odpowiada za przygotowanie i konfigurację środowiska chmurowego Azure Kubernetes Service (AKS), zarządzanie grupami zasobów oraz uprawnieniami dostępu (RBAC).
